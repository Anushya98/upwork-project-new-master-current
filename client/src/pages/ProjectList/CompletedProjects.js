...
//const randomColor = colors['#' + Math.floor(Math.random() * colors.length).toString(16)];
// const {stats} = this.state;
// const alternatingColor = ["red", "blue"];
            ...
            style={{ 
              ...
              key={key}>
                ...
                >
                  ...
                  <div className="row" style={{ marginTop: "-5%", width: "300px" }}>
                    {currentUser &&
                    ...
                    {project.state === "Completed" && (
                      <div className="col-sm text-center" style={{ color: "#228b22", padding: "3%", borderTop: "1px dashed rgb(39 112 149 / 32%)"}}>
                        Project Approved!
                      </div>
                    )}
                  </div>
