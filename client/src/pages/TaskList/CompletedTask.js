...
// function dateDiffInHours(updatedDate) {
//   let diffTime = Math.abs(
//     new Date().valueOf() - new Date(updatedDate).valueOf()
//   );
...
//   let value;
//   if (days === 0) {
//     value = "Updated " + hours + " hrs " + minutes + " minutes ago";
//   }
//   if (hours === 0) {
//     value = " Updated " + minutes + " minutes ago";
//   }
//   if (days === 0 && hours === 0 && minutes === 0) value = "New Updated";
//   return value;
// }
const CompletedProjects = ({ value }) => {
  console.log(value);
  ...
  const roleHasCancelPermission = ["superadmin", "admin", "user"];
      ...
      >
        {tasks.map((project, key) => {
          ...
          return (
            <>
             {[
    { color: 'linear-gradient(90deg, hsla(332, 53%, 82%, 1) 0%, hsla(176, 57%, 89%, 1) 100%)', textColor: 'primary' },
    { color: 'linear-gradient(to right, #ffa585, #ffeda0)', textColor: 'secondary' },
    { color: 'linear-gradient(to right, #ebf4f5, #b5c6e0)', textColor: 'secondary' }   
  ].map((item) => (
